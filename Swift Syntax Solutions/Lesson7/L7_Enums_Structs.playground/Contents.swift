...
var happyHourBeer = Beer(style:"Lager", percentAlcohol: 13.0)
happyHourBeer.suggestedVolumePerServing
Beer.cheers("Italian")
print(Beer.cheersDict["Japanese"]!)
if let japansese = Beer.cheersDict["Japanese."] {
    print(japansese)
} else {
    print("No Japanese. for key")
}
